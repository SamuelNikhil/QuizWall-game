    ...
    return (
      <div className="controller-container">
        <div className="waiting-screen">
          ...
          <h2 className="waiting-title" style={{ color: "#f87171" }}>
            Access Denied
          </h2>
  ...
  if (!joined) {
    return (
      <div className="controller-container">
        <div className="waiting-screen">
          <div className="pulse-ring" />
          <h2 className="waiting-title">Joining Room {roomId}...</h2>
        </div>
      </div>
    );
  }
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Enable gyroscope for precise aiming. Tap the button below to start.
          </p>
          <button
    ...
    >
      <header className="controller-header">
        <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
          <p
            className={`controller-status ${joined ? "connected" : ""}`}
            style={{ margin: 0 }}
          >
          ...
          >
            Room: {roomId} {gyroEnabled ? "📱 Gyro ON" : ""}
          </p>
        </div>
        ...
        <div className="slingshot-base">
          {isDragging && power > 5 && (
            <div
              ...
              style={{
                width: power * 2,
                transform: `rotate(${Math.atan2(-pullBack.y, -pullBack.x) * (180 / Math.PI)}deg)`,
                left: "50%",
                top: "50%",
              }}
            />
          ...
          <div
            ...
            style={{
              ...
              boxShadow: isDragging
                ? "0 0 40px var(--accent-primary), 0 0 60px var(--accent-primary)"
